#!/bin/bash
##### STEP 2 #####
echo -e "Welcome to STEP 2"

##### PROCESS step 1 #####
# Make sure we're in the correct directory
echo -e "We should be in fastqc_out/"
cd fastqc_out/
...
echo -e "You are now in ${PWD}"
echo -e "Moving all shell scripts except STEP0 into ${PWD}"
mv ../STEP* .
mv STEP0_copy_fastq.sh ..
echo -e "Moving complete"
